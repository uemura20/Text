...
//                    System.out.println(arr_info[i].name.compareTo(arr_info[j].name));
                    if (arr_info[i].gender.compareTo(arr_info[j].gender) <= 0) {
                        min = arr_info[i].gender;
                        mins[i] = Info[i];
                    } else {
                        min = arr_info[j].gender;
                        arr_info[j].gender = arr_info[i].gender;
                        arr_info[i].gender = min;
