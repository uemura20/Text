...
//                    System.out.println(arr_info[i].age + arr_info[j].age);
//                    System.out.println(arr_info[i].age.compareTo(arr_info[j].age));
                    if (arr_info[i].age.compareTo(arr_info[j].age) <= 0) {
                        min = arr_info[i].age;
                        mins[i] = Info[i];
                    } else {
                        min = arr_info[j].age;
                        arr_info[j].age = arr_info[i].age;
                        arr_info[i].age = min;
